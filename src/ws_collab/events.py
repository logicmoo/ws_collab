...
CONVERSATION_SILENCE_ACTION_EVALUATED = "CONVERSATION_SILENCE_ACTION_EVALUATED"
CONVERSATION_FLOOR_CONTINUE = "CONVERSATION_FLOOR_CONTINUE"
CONVERSATION_FLOOR_INVALIDATED = "CONVERSATION_FLOOR_INVALIDATED"
