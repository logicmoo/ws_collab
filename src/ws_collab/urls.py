...
MEET_BRIDGE_MEDIA_MUTE = join_path(MEET_BRIDGE_PREFIX, "media-mute")
MEET_BRIDGE_DEVICE_SYNC = join_path(MEET_BRIDGE_PREFIX, "device-sync")
...
MEET_BRIDGE_AUTHENTICATED_PATHS = frozenset(
    {
        MEET_BRIDGE_WIRE_AUDIO,
        MEET_BRIDGE_DISCONNECT_AUDIO,
        MEET_BRIDGE_MEDIA_MUTE,
